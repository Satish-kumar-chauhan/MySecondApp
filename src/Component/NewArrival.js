...
import newArrivalBanner from '../assets/images/new-arrival-banner2.png'
      ...
      <div className='container'>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={12} md={4} lg={4} xl={4} xxl={4} data-aos="fade-right" data-aos-duration="400">
            <Item className='ArtistImg'><img data-aos='zoom-in' data-aos-duration='1000' src={newArrivalBanner} className='h-100 w-100'/></Item>
          </Grid>
